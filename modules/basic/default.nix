    ...
    config = (
        ...
        in {
            ...
            vim.configRC = ''
                ...
                ${writeIf cfg.splitBelow        "set splitbelow"}
                ${writeIf cfg.splitRight        "set splitright"}
                ${writeIf cfg.showSignColumn    "set signcolumn=yes"}
                ${writeIf cfg.autoIndent        "set autoindent"}
